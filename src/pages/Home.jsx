  ...
  return (
    <div>
      <div className="flex justify-between">
        {/* Typewriter */}
        <div className="pt-20 pl-4 mb-0 h-[50vh] flex-col shrink-0 text-[#2C0472] text-[64px] not-italic font-normal leading-[normal]; font-family: Lato;">
          <h1 className="text-4xl">At Healify we can save</h1>
          <span className="flex w-[550px] flex-col shrink-0 text-[#2C0472] text-6xl not-italic font-normal leading-[normal]; font-bold;">
            Your {word}
          </span>
        </div>
        <img
