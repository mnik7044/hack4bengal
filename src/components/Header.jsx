...
export default function Header() {
  ...
  const menuItems = [
    ...
    { path: "/MentalHealth", label: "Mental Health" },
      ...
      <header className="h-[65px] flex justify-between items-center px-3 mx-auto">
        <div className="flex items-center w-[276px] h-[77px] shrink-0">
          <img
            ...
            onClick={() => navigate("/")}
          />
          <p className="text-[#233348] text-4xl not-italic font-bold leading-normal pl-3 font-family: Poppins cursor-pointer" onClick={() => navigate("/")}>HEALIFY</p>
        </div>
        <div className=" pr-6">
